...
type ReportAcceleration struct {
	...
	SourceLocalTable   string `gorm:"column:source_local_table;type:varchar(128)" json:"sourceLocalTable"`
	...
	TargetLocalTable   string `gorm:"column:target_local_table;type:varchar(128)" json:"targetLocalTable"`
	MVName             string `gorm:"column:mv_name;type:text" json:"mvName"`
	ClusterName        string `gorm:"column:cluster_name;type:varchar(128)" json:"clusterName"`
