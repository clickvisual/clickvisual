export default {
  ...
  "logLibraryManagement.instance": "选择实例",
  "logLibraryManagement.database": "选择数据库",
  "logLibraryManagement.table": "日志库",
  "logLibraryManagement.search": "搜索日志库、实例或数据库",
  "logLibraryManagement.empty": "暂无日志库",
  "logLibraryManagement.loadError": "日志库列表加载失败",
  "logLibraryManagement.selectDatabase": "请先选择数据库",
  "logLibraryManagement.delete.title": "删除日志库",
  "logLibraryManagement.delete.content":
    "即将删除实例“{instance}”数据库“{database}”中的日志库“{name}”。此操作将删除物理表，并可能影响关联告警，确定继续吗？",
  "logLibraryManagement.delete.success": "日志库删除成功",
  "logLibraryManagement.delete.error": "日志库删除失败",
  "logLibraryManagement.forbidden": "仅管理员可访问日志管理",
  "logLibraryManagement.backToQuery": "返回日志查询",
  "logLibraryManagement.schema": "查看结构",
  "logLibraryManagement.ddl": "查看 DDL",
  "logLibraryManagement.column.name": "字段名",
  "logLibraryManagement.column.type": "字段类型",
  "logLibraryManagement.inspectError": "元数据加载失败，请重试",
  "logLibraryManagement.ddl.copy": "复制 DDL",
  "logLibraryManagement.ddl.copied": "DDL 已复制",
  "logLibraryManagement.ddl.copyError": "DDL 复制失败",
  retry: "重试",
  "menu.bigdata": "分析",
...
"log":"{"time": "2023-12-14T07:41:56+00:00", "client_ip": "192.168.1.1"}"
  ...
  "log.search.help.content.directionsUse.url":
    "https://clickvisual.net/zh/clickvisual/03funcintro/instructions.html",
