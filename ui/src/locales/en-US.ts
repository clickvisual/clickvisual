export default {
  ...
  "menu.systemSettings.logLibraries": "Log libraries",
  "logLibraryManagement.title": "Log libraries",
  ...
  "logLibraryManagement.schema": "View schema",
  "logLibraryManagement.ddl": "View DDL",
  "logLibraryManagement.column.name": "Column",
  "logLibraryManagement.column.type": "Type",
  "logLibraryManagement.inspectError": "Failed to load metadata. Please retry.",
  "logLibraryManagement.ddl.copy": "Copy DDL",
  "logLibraryManagement.ddl.copied": "DDL copied",
  "logLibraryManagement.ddl.copyError": "Failed to copy DDL",
  retry: "Retry",
