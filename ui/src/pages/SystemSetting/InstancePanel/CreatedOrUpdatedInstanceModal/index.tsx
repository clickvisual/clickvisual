import instanceModalStyles from '@/pages/SystemSetting/InstancePanel/CreatedOrUpdatedInstanceModal/index.less';
...
const CreatedOrUpdatedInstanceModal = (props: CreatedOrUpdatedInstanceModalProps) => {
  const { visible, isEditor, current, onCancel } = props;
  const { doCreatedInstance, doUpdatedInstance, doGetInstanceList } = useModel('systemSetting');
