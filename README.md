...
ClickVisual is a lightweight browser-based logs analytics and logs search platform for ClickHouse, we are from [@ShimoDocs](https://github.com/shimodocs/shimodocs)
