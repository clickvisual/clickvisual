...
CREATE TABLE `mogo_base_table` (
    ...
    `typ` int(11) DEFAULT NULL COMMENT 'time_field 解析类型 1 String 2 Float',
    ...
    `create_type` tinyint(1) NOT NULL COMMENT '0 mogo建表 1 已有数据表',
    `time_field` varchar(128) NOT NULL COMMENT '_time_',
